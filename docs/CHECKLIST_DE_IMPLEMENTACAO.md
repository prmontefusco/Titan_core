...
| ADR-0042b | Artefato recebido e lacuna de cobertura | IMPLEMENTADO | Pendente validação manual |
...
|---|---|---|---|---|---|
| 1 | Alta | Continuidade de proveniência e lacuna auditável (ADR-0042) | Elegibilidade para mercados e fornecedor indireto dependem de cadeia além da própria Organization | Contraparte externa, saída estruturada e artefato recebido com lacuna implementados; validação manual do artefato pendente; fatos importados ainda pendentes | Registrar fatos importados preservando autoria, origem, confiança e artefato fonte |
...
| 26/07/2026 | Artefato recebido e lacuna de cobertura | IMPLEMENTADO | ADR-0042; `apps/validacao/artefato_transferencia.py`; validação manual pendente |
