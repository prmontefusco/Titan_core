...
**Próximo passo planejado:** ADR-0047 (correção de `TransformationEvent` publicado, Passo 11.7) aceita após três rodadas de revisão; implementação ainda não iniciada.
