...
**Próximo passo planejado:** Passo 11.2 (fan-out real de abate) implementado e validado; decidir com o responsável se inicia o Passo 11.3 (timeline/recall de `TraceableItem`) ou 11.5 (API e dossiê).
