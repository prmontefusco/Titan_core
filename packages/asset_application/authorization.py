...
# -- SLIContract (módulo sustainment) -----------------------------------

CONTRACT_REGISTER: Final = "SUSTAINMENT_CONTRACT.REGISTER"
CONTRACT_ISSUE_VERSION: Final = "SUSTAINMENT_CONTRACT.ISSUE_VERSION"
CONTRACT_AMEND: Final = "SUSTAINMENT_CONTRACT.AMEND"
CONTRACT_READ: Final = "SUSTAINMENT_CONTRACT.READ"

# -- WorkOrder (módulo sustainment) --------------------------------------

WO_OPEN: Final = "SUSTAINMENT_WO.OPEN"
WO_ADD_TASK: Final = "SUSTAINMENT_WO.ADD_TASK"
WO_DEMAND_MATERIAL: Final = "SUSTAINMENT_WO.DEMAND_MATERIAL"
WO_RESERVE_MATERIAL: Final = "SUSTAINMENT_WO.RESERVE_MATERIAL"
WO_RECALC_PRIORITY: Final = "SUSTAINMENT_WO.RECALC_PRIORITY"
WO_TRANSITION: Final = "SUSTAINMENT_WO.TRANSITION"
WO_EXECUTE: Final = "SUSTAINMENT_WO.EXECUTE"
WO_RECORD_REMOVAL: Final = "SUSTAINMENT_WO.RECORD_REMOVAL"
WO_TECH_COMPLETE: Final = "SUSTAINMENT_WO.TECH_COMPLETE"
WO_VALIDATE: Final = "SUSTAINMENT_WO.VALIDATE"
WO_CLOSE: Final = "SUSTAINMENT_WO.CLOSE"
WO_CANCEL: Final = "SUSTAINMENT_WO.CANCEL"
WO_RECORD_FAILURE: Final = "SUSTAINMENT_WO.RECORD_FAILURE"
WO_READ: Final = "SUSTAINMENT_WO.READ"
