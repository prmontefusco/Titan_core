...
class DossierBundleInterpreterPort(Protocol):
    """InterpretaÃ§Ã£o declarativa opcional de Dossier pertencente Ã  uma vertical."""
...
class VerificationBundleService:
    ...
    dossier_interpreters: Sequence[DossierBundleInterpreterPort] = ()
    ...
    def build_from_dossier(
        ...
        for interpreter in self.dossier_interpreters:
            auto_scopes, auto_gaps = interpreter.declared_scopes_and_gaps(dossier)
